<template>
    ...
    <div class="w-1/4 bg-[#0F172A]">
      <!-- header sidebar -->
      <div class="h-[80px] bg-[#0F172A] flex justify-start align-center">
        <div class="flex">
      ...
      <div class="flex-1 bg-[#0F172A] py-[20px]">
        <div class="pr-[20px] flex flex-col justify-between space-y-[10px] text-white">
          <!-- Dashboard -->
          <router-link 
            to="/dashboard" 
            class="inline-flex relative items-center py-[15px] px-[30px] w-full text-xl font-medium rounded-r-[30px] border-[#FF5E01] hover:bg-[#FF5E01] hover:text-white"
