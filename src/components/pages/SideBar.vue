   ...
   <div class="w-1/4 bg-[#0F172A]">
        ...
        <div class="flex-1 bg-[#0F172A] py-[20px]">
            <div class="pr-[20px] flex flex-col justify-between space-y-[10px] text-white">
                <!-- Dashboard -->
                <router-link to="/bookshift" class="inline-flex relative intems-center py-[15px] px-[30px] w-full text-xl font-medium rounded-r-[30px] border-[#FF5E01] hover:bg-[#FF5E01] hover:text-white">
