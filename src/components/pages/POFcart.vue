<template>
    <div class="h-1/4 w-full bg-white px-6 py-2 flex items-center justify-around">
        ...
        <div class="relative flex items-center max-w-[5rem] max-h-[30px] px-2 border rounded-full mx-auto">
            <button type="button" id="decrement-button" data-input-counter-decrement="quantity-input" class=" bg-transparent">
            ...
            <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" class="max-h-[30px] bg-transparent border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm block w-full py-2.5  " placeholder="00"/>
            <button type="button" id="increment-button" data-input-counter-increment="quantity-input" class=" bg-transparent">
        ...
        <!-- <font-awesome-icon icon="trash-plus" class="mt-1 text-[#009C22] w-[24px] h-[24px] ml-2 mr-2" /> -->
